    ...
    "Statement": [
        {
            ...
            "Condition": {
                "StringEquals": {
                    "oidc.eks.${data.aws_caller_identity.current.account_id}.amazonaws.com/id/${local.oidc}:aud": "sts.amazonaws.com",
                    "oidc.eks.${data.aws_caller_identity.current.account_id}.amazonaws.com/id/EXAMPLE5D39D4633E53DE1B71EXAMPLE:sub": "system:serviceaccount:kube-system:aws-load-balancer-controller"
                }
            }
        }
    ]
